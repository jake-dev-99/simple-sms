...
public class EyesFreeVidService extends CameraExtensionService {
    ...
    protected static final Key REQUEST_AVAILABLE_DYNAMIC_RANGE_PROFILES_MAP = new Key<long[]>(
            "android.request.availableDynamicRangeProfilesMap", long[].class);
    protected static final Key REQUEST_AVAILABLE_COLOR_SPACE_PROFILES_MAP = new Key<long[]>(
            "android.request.availableColorSpaceProfilesMap", long[].class);
    ...
    public static class AdvancedExtenderEyesFreeImpl extends AdvancedExtender {
        ...
        public List<Pair<CameraCharacteristics.Key, Object>> getAvailableCharacteristicsKeyValues() {
            ...
            StreamConfiguration[] filteredConfigurations = new StreamConfiguration[tmpConfigs.size()];
            ...
            StreamConfigurationDuration[] filteredMinFrameDurations = new StreamConfigurationDuration[tmpMinFrameDurations
                    .size()];
            ...
            StreamConfigurationDuration[] filteredStallDurations = new StreamConfigurationDuration[tmpStallDurations
                    .size()];
            ...
            return Arrays.asList(
                    ...
                    Pair.create(
                            ...
                            new int[] { CameraCharacteristics.CONTROL_VIDEO_STABILIZATION_MODE_PREVIEW_STABILIZATION
                            }),
