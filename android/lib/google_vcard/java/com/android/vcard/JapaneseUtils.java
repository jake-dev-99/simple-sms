...
/* package */ class JapaneseUtils {
    @VisibleForTesting
    static final Map<Character, String> sHalfWidthMap = new HashMap<Character, String>();
    ...
    /**
     * Returns half-width version of that character if possible. Returns null if not
     * possible
     * 
