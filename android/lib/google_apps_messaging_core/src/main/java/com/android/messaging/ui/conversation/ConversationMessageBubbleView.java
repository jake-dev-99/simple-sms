...
/**
 * Shows the message bubble for one conversation message. It is able to animate
 * size changes
 * by morphing when the message content changes size.
 */
// TODO: Move functionality from ConversationMessageView into this class as
// appropriate
public class ConversationMessageBubbleView extends LinearLayout {
    ...
    public void bind(final ConversationMessageData data) {
        ...
        // Animate width change only when we are binding to the same message, so that we
        // may
        // animate view size changes on the same message bubble due to things like
        // status text
        // change.
        // Don't animate width change when the bubble contains attachments. Width
        // animation is
        // only suitable for text-only messages (where the bubble size change due to
        // status or
        // time stamp changes).
    ...
    public void kickOffMorphAnimation(final int oldWidth, final int newWidth) {
        ...
        mAnimator.addListener(new AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                // the animation. This will snap to the bigger size if needed. This is
                // intentional
