...
public class GroupMmsSettingDialog {
    ...
    private View createView() {
        ...
        final RadioButton disableButton = (RadioButton) rootView.findViewById(R.id.disable_group_mms_button);
        final RadioButton enableButton = (RadioButton) rootView.findViewById(R.id.enable_group_mms_button);
