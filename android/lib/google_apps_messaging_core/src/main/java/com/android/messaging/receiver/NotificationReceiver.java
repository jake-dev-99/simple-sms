...
public class NotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        if (intent.getAction().equals(UIIntents.ACTION_RESET_NOTIFICATIONS)) {
            final String conversationIdSetString = intent.getStringExtra(UIIntents.UI_INTENT_EXTRA_CONVERSATION_ID_SET);
            ...
            if (conversationIdSetString == null) {
                ...
                for (final String conversationId : ConversationIdSet.createSet(conversationIdSetString)) {
