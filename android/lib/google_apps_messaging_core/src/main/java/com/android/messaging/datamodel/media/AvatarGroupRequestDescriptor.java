...
public class AvatarGroupRequestDescriptor extends CompositeImageRequestDescriptor {
    ...
    private static List<? extends ImageRequestDescriptor> convertToDescriptor(final Uri uri,
        ...
        final List<AvatarRequestDescriptor> avatarDescriptors = new ArrayList<AvatarRequestDescriptor>(
                participantUriStrings.size());
    ...
    /**
     * Generates an array of {@link RectF} which represents where each of the
     * individual avatar
     * should be located in the final group avatar image. The location of each
     * avatar depends on
    ...
    private RectF[] generateDestRectArray() {
        ...
        switch (groupSize) {
            case 2:
                 ...
                 * diagonal of the overall group avatar is squareRoot(2) * w We also know that
                 * the
            ...
            case 3:
                 ...
                 * image one or image two. Move image zero down so it touches image one and
                 * image
                 * two. This can be done by keeping image zero in the center and moving it down
                 * slightly. The amount to move down can be calculated by solving a right
                 * triangle.
                 ...
                 * distance from image zero to image two's center is 2 * radius, edge c. From
                 * this
                 * we know that the distance from center y of image two to center y of image
                 * one,
                 * edge a, is equal to radius * squareRoot(3) due to this triangle being a
                 * 30-60-90
                 * right triangle.
                 */
