...
/**
 * Action used to fixup actively downloading or sending status at startup - just
 * in case we
 * crash - never run this when a message might actually be sending or
 * downloading.
 */
public class FixupMessageStatusOnStartupAction extends Action implements Parcelable {
    ...
    public static final Parcelable.Creator<FixupMessageStatusOnStartupAction> CREATOR = new Parcelable.Creator<FixupMessageStatusOnStartupAction>() {
        @Override
