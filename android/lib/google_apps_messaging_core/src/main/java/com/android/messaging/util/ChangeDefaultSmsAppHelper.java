...
public class ChangeDefaultSmsAppHelper {
     ...
     * message,
     * call warnOfMissingActionConditions to put up a toast and allow the user to
     * repair
     * that condition.
     * 
     ...
     *                            positively to the condition prompt and resolves
     *                            the condition. It is
     *                            preferable to specify the value in
     *                            {@link #handleChangeDefaultSmsResult}
     *                            as that handles the case where the process gets
     *                            restarted.
     *                            If null, the user will be shown a generic toast
     *                            message.
     * @param composeView         - compose view that may have the keyboard opened
     *                            and focused
     * @param rootView            - if non-null, use this to attach a snackBar
     * @param activity            - calling activity
     * @param fragment            - calling fragment, may be null if called directly
     *                            from an activity
     */
    ...
    private void promptToChangeDefaultSmsApp(final boolean sending,
        ...
        if (rootView == null) {
            ...
            UiUtils.showSnackBarWithCustomAction(activity,
                    rootView,
                    activity.getString(
                            sending ? R.string.requires_default_sms_app_to_send : R.string.requires_default_sms_app),
