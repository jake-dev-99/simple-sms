...
public class FileImageRequestDescriptor extends UriImageRequestDescriptor {
    ...
    /**
     * Creates a new file image request with this descriptor. Oftentimes image file
     * metadata
     * has information such as the size of the image. Provide these metrics if they
     * are known.
     */
    public FileImageRequestDescriptor(final String path, final int desiredWidth,
    ...
    public String getKey() {
        ...
        return prefixKey == null ? null
                : new StringBuilder(prefixKey).append(KEY_PART_DELIMITER)
