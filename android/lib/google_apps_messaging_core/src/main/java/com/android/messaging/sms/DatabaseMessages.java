...
public class DatabaseMessages {
    ...
    public static class MmsMessage extends DatabaseMessage implements Parcelable {
        ...
        /**
         * Process loaded MMS parts to obtain the combined text, the combined attachment
         * url,
        ...
        public static final Parcelable.Creator<MmsMessage> CREATOR = new Parcelable.Creator<MmsMessage>() {
            @Override
    ...
    public static class MmsPart implements Parcelable {
        ...
        private static String extractContentType(final Context context, final Uri uri) {
            ...
            if (TextUtils.isEmpty(extension)) {
                // getMimeTypeFromExtension() doesn't handle spaces in filenames nor can it
                // handle
        ...
        private void loadImage() {
            ...
            final Uri uri = getDataUri();
            // We have to get the width and height of the image -- they're needed when
            // adding
        ...
        private void loadVideo() {
            // This is a coarse check, and should not be applied to outgoing messages.
            // However,
            ...
            try {
                ...
                // messages on some carrier. We should handle this in a less accidental way so
                // that
                ...
                mContentType = retriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_MIMETYPE);
        ...
        /**
         * @return If the type is a text type that stores text embedded (i.e. in db
         *         table)
         */
    ...
    public static class LocalDatabaseMessage extends DatabaseMessage implements Parcelable {
        ...
        public static final Parcelable.Creator<LocalDatabaseMessage> CREATOR = new Parcelable.Creator<LocalDatabaseMessage>() {
            @Override
