...
public class MarkAsSeenAction extends Action implements Parcelable {
     ...
     * 
     * @param conversationId the conversation id for which to mark as seen, or null
     *                       to mark all
     *                       messages as seen
     */
    ...
    public static final Parcelable.Creator<MarkAsSeenAction> CREATOR = new Parcelable.Creator<MarkAsSeenAction>() {
        @Override
