...
/**
 * Provides an interface to expose Conversation Message Cursor data to a UI
 * widget like a
 * RecyclerView.
 */
public class ConversationMessageAdapter extends
    ...
    public void bindViewHolder(final ConversationMessageViewHolder holder,
        ...
        final ConversationMessageView conversationMessageView = (ConversationMessageView) holder.mView;
    ...
    public ConversationMessageViewHolder createViewHolder(final Context context,
        ...
        final ConversationMessageView conversationMessageView = (ConversationMessageView) layoutInflater
                .inflate(R.layout.conversation_message_view, null);
    ...
    public static class ConversationMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        /**
         * @param viewClickListener a View.OnClickListener that should define the
         *                          interaction when
