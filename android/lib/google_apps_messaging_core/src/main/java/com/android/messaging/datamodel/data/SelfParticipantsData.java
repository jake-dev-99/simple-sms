...
/**
 * A class that contains the list of all self participants potentially involved
 * in a conversation.
 * This class contains both active/inactive self entries when there is multi-SIM
 * support.
 */
public class SelfParticipantsData {
    /**
     * The map from self participant ids to self-participant data entries in the
     * participants table.
     ...
     * 
     * @param activeOnly if set, returns active self entries only (i.e. those with
     *                   SIMs plugged in).
     */
