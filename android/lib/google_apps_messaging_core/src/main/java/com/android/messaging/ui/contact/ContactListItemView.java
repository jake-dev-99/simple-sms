...
public class ContactListItemView extends LinearLayout implements OnClickListener {
    ...
    /**
     * Fills in the data associated with this view by binding to a contact cursor
     * provided by
     * ContactUtil.
     *
     * @param cursor                   the contact cursor.
     * @param hostInterface            host interface to this view.
     * @param shouldShowAlphabetHeader whether an alphabetical header should shown
     *                                 on the side
     *                                 of this view. If {@code headerLabel} is
     *                                 empty, we will still leave space for it.
     * @param headerLabel              the alphabetical header on the side of this
     *                                 view, if it should be shown.
     */
    ...
    /**
     * Binds a RecipientEntry. This is used by the chips text view's dropdown
     * layout.
     *
     * @param recipientEntry    the source RecipientEntry provided by
     *                          ContactDropdownLayouter, which
     *                          was in turn directly from one of the existing chips,
     *                          or from filtered results
     *                          generated by ContactRecipientAdapter.
     * @param styledName        display name where the portion that matches the
     *                          search text is bold.
     * @param styledDestination number where the portion that matches the search
     *                          text is bold.
     * @param hostInterface     host interface to this view.
     * @param isSingleRecipient whether this item is shown as the only line item in
     *                          the single
     *                          recipient drop down from the chips view. If this is
     *                          the case, we always show the
    ...
    private void updateViewAppearance() {
        ...
        if (mData.getIsSimpleContactItem()) {
            // This is a special number-with-avatar type of contact (for unknown contact
            // chips
            // and for direct "send to destination" item). In this case, make sure we only
            // show
