...
public abstract class UIIntents {
    ...
    // Sending draft data (from share intent / message forwarding) to the
    ...
    /**
     * Launch an activity to show a conversation. This method by default provides no
     * additional
     * activity options.
     */
     ...
     * @param clickPosition is the location tapped to start this launch for
     *                      transition use
     */
    ...
    /**
     * Launch an activity to let the user select & unselect the list of attachments
     * to send.
     */
     ...
     * 
     * @param topLevel indicates whether the app settings is launched as the
     *                 top-level settings
     *                 activity (instead of SettingsActivity which shows a collapsed
     *                 view of the app
     *                 settings + one settings item per subscription). This is true
     *                 when there's only one
     *                 active SIM in the system so we can show this activity
     *                 directly.
     */
     ...
     * @param toneType    type of ringtone to pick, maybe any of
    ...
    /**
     * Broadcast conversation self id change so it may be reflected in the message
     * compose UI.
     */
    ...
    /**
     * Get a PendingIntent for sending a message to a conversation, without opening
     * the Bugle UI.
     *
     * <p>
     * This is intended to be used by the Android Wear companion app when sending
     * transcribed
     * voice replies.
     */
     ...
     *
     * <p>
     * This is intended to be used by notifications.
     */
    ...
    /**
     * Get a PendingIntent for the conversation widget configuration activity
     * template.
     */
