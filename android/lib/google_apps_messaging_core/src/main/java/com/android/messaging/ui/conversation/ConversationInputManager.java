...
/**
 * Manages showing/hiding/persisting different mutually exclusive UI components
 * nested in
 * ConversationFragment that take user inputs, i.e. media picker, SIM selector
 * and
 * IME keyboard (the IME keyboard is not owned by Bugle, but we try to model it
 * the same way
 * as the other components).
 */
public class ConversationInputManager implements ConversationInput.ConversationInputBase {
    /**
     * The host component where all input components are contained. This is
     * typically the
    ...
    /**
     * The "sink" component where all inputs components will direct the user inputs
     * to. This is
    ...
    public void onDetach() {
        ...
        // Don't need to explicitly unregister for data model events. It will unregister
        // all
    ...
    public void handleOnShow(final ConversationInput target) {
        ...
        // The one exception, is that the keyboard and location media chooser can be
        // open at the
