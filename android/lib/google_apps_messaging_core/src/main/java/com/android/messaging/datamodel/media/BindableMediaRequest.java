...
/**
 * The {@link MediaRequest} interface is threading-model-oblivious, allowing the
 * implementations to
 * be processed synchronously or asynchronously.
 * This is a {@link MediaRequest} implementation that includes functionalities
 * such as binding and
...
public abstract class BindableMediaRequest<T extends RefCountedMediaResource>
    ...
    /**
     * Delegates the media resource callback to the listener. Performs binding check
     * to ensure
