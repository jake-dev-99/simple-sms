...
public class UriUtil {
    ...
    /**
     * Gets the content:// style URI for the given MediaStore row Id in the files
     * table on the
     * external volume.
     *
    ...
    /**
     * Gets the size in bytes for the content uri. Currently we only support content
     * in the
     * scratch space.
     */
    ...
    /**
     * Persist a piece of content from the given input stream, byte by byte to the
     * scratch
     * directory.
     * 
     ...
     * SCHEME:destination[,destination]?otherstuff
    ...
    public static String parseRecipientsFromSmsMmsUri(final Uri uri) {
        ...
        // replaceUnicodeDigits will replace digits typed in other languages (i.e.
        // Egyptian) with
