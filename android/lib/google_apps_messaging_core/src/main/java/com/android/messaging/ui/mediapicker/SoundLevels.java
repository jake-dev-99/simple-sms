...
/**
 * This view draws circular sound levels. By default the sound levels are black,
 * unless
...
public class SoundLevels extends View {
    ...
    // The minimum size of the levels as a percentage of the max, that is the size
    // when volume is 0.
    ...
    public SoundLevels(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        // TODO: We could probably remove this in favor of using
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        if (!mCenterDefined) {
            // One time computation here, because we can't rely on getWidth() to be computed
            // at
        ...
        // Either ease towards the target level, or decay away from it depending on
        // whether
