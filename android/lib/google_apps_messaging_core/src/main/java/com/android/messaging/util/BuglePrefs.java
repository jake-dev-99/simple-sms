...
public abstract class BuglePrefs {
     ...
     * Note: for all subscription-specific preferences, please prefix the shared
     * preference keys
     * with "buglesub_", so that Bugle may perform runtime validations on
     * preferences to make sure
     * you don't accidentally write per-subscription settings into the general pref
     * file, and vice
     * versa.
     */
    ...
    /**
     * A placeholder base version for Bugle builds where no shared pref version was
     * defined.
     */
