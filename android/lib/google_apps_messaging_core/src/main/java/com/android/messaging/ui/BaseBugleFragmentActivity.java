...
/**
 * Base class for app activities that would normally derive from
 * FragmentActivity. Responsible for
...
public class BaseBugleFragmentActivity extends Activity {
    ...
    protected void onResume() {
        ...
        // Ensure we have a sufficient version of Google Play Services, prompting for
        // upgrade and
