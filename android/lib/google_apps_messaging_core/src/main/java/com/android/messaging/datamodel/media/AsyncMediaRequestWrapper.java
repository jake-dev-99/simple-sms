...
/**
 * A mix-in style class that wraps around a normal, threading-agnostic
 * MediaRequest object with
 * functionalities offered by {@link BindableMediaRequest} to allow for async
 * processing.
 */
class AsyncMediaRequestWrapper<T extends RefCountedMediaResource> extends BindableMediaRequest<T> {
     ...
     */
    public static <T extends RefCountedMediaResource> AsyncMediaRequestWrapper<T> createWith(
