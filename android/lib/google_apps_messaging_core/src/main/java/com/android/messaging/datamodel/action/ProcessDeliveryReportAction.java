...
public class ProcessDeliveryReportAction extends Action implements Parcelable {
    ...
    protected Object executeAction() {
        ...
        try {
            ...
            final MessageData messageData = BugleDatabaseOperations.readMessageData(db, smsMessageUri);
    ...
    public static final Parcelable.Creator<ProcessDeliveryReportAction> CREATOR = new Parcelable.Creator<ProcessDeliveryReportAction>() {
        @Override
