...
abstract class MediaChooser extends BasePagerViewHolder
    ...
    /**
     * Used by subclasses to indicate that no loader is required from the data model
     * in order for
    ...
    protected FragmentManager getFragmentManager() {
        return OsUtil.isAtLeastJB_MR1() ? mMediaPicker.getChildFragmentManager() : mMediaPicker.getFragmentManager();
    }
    ...
    /**
     * @return The resource id of the string to use for the accessibility text of
     *         the icon
     */
    ...
    /**
     * Called by the MediaPicker to determine whether this panel can be swiped down
     * further. If
     * not, then a swipe down gestured will be captured by the MediaPickerPanel to
     * shrink the
     * entire panel.
     */
    ...
    /**
     * Typically the media picker is closed when the IME is opened, but this allows
     * the chooser to
    ...
    /**
     * Returns true if the chooser is owning any incoming touch events, so that the
     * media picker
