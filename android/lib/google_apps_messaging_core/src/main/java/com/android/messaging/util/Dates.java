...
public class Dates {
    ...
    // Callers of methods in this class should never have to specify these; this is
    // really
    ...
    public static CharSequence getRelativeTimeSpanString(final long time) {
        ...
        // Workaround for b/5657035. The platform method {@link
        // DateUtils#getRelativeTimeSpan()}
        // passes a null context to other platform methods. However, on some devices,
        // this
        // context is dereferenced when it shouldn't be and an NPE is thrown. We catch
        // that
