 ...
 * {@link SubscriptionListData.SubscriptionListEntry}'s, one for each *active*
 * subscriptions.
 *
 * This is used to:
 ...
 *
 * It builds on top of SelfParticipantsData and performs additional logic such
 * as determining
...
public class SubscriptionListData {
    ...
    public static class SubscriptionListEntry {
        ...
        static SubscriptionListEntry fromSelfParticipantData(
            ...
            final String displayName = TextUtils.isEmpty(subscriptionName)
                    ? context.getString(R.string.sim_slot_identifier, String.valueOf(slotId))
                    : subscriptionName;
    ...
    public void bind(final List<ParticipantData> subs) {
        ...
        for (final ParticipantData sub : subs) {
            final SubscriptionListEntry entry = SubscriptionListEntry.fromSelfParticipantData(sub, mContext);
