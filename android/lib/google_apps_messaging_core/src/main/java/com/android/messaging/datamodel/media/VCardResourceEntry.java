...
/**
 * Holds one entry item (i.e. a single contact) within a VCard resource. It is
 * able to take
...
public class VCardResourceEntry {
    ...
    /**
     * Returns a UI-facing representation that can be bound and consumed by the UI
     * layer to display
    ...
    /**
     * Represents one entry line (e.g. phone number and phone label) for a single
     * contact. Each
