 ...
 * It releases
 * ref on the entries as they are evicted from the cache, and it uses the media
 * resource
 * size in kilobytes, instead of the entry count, as the size of the cache.
 *
 * This class is used by the MediaResourceManager class to maintain a number of
 * caches for
...
public class MediaCache<T extends RefCountedMediaResource> extends LruCache<String, T> {
    ...
    /**
     * Gets a media resource from this cache. Must use this method to get resource
     * instead of get()
