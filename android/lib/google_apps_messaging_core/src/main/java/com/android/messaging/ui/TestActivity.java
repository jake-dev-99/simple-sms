...
/**
 * An empty activity that can be used to host a fragment or view for unit
 * testing purposes. Lives in
...
public class TestActivity extends FragmentActivity {
    ...
    protected void onCreate(final Bundle bundle) {
        ...
        if (bundle != null) {
            // The test case may have configured the fragment, and recreating the activity
            // will
            // lose that configuration. The real activity is the only activity that would
            // know
            // how to reapply that configuration.
            throw new IllegalStateException("TestActivity cannot get recreated");
        }

        // There is a race condition, but this often makes it possible for tests to run
        // with the
        // key guard up
