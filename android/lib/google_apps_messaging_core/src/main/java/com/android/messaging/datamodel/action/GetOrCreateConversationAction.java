...
/**
 * Action used to get or create a conversation for a list of conversation
 * participants.
 */
public class GetOrCreateConversationAction extends Action implements Parcelable {
    ...
    public static GetOrCreateConversationActionMonitor getOrCreateConversation(
        ...
        final GetOrCreateConversationActionMonitor monitor = new GetOrCreateConversationActionMonitor(data, listener);
    ...
    protected Object executeAction() {
        ...
        final ArrayList<ParticipantData> participants = actionParameters.getParcelableArrayList(KEY_PARTICIPANTS_LIST);
    ...
    public static final Parcelable.Creator<GetOrCreateConversationAction> CREATOR = new Parcelable.Creator<GetOrCreateConversationAction>() {
        @Override
