...
public class SmsStorageLowWarningFragment extends Fragment {
    ...
    /**
     * The dialog to show for user to choose what delete actions to take when
     * storage is low
     */
    ...
    public static class ConfirmationDialog extends DialogFragment {
        ...
        private void handleAction(final int actionIndex) {
            final long durationInMillis = SmsReleaseStorage.durationToTimeInMillis(mDuration);
            switch (actionIndex) {
                case 0:
    ...
    private static List<String> loadFreeStorageActions(final Resources resources) {
        ...
        // actions.add(resources.getString(R.string.auto_delete_oldest_messages,
        // durationString));
        return actions;
    }
}
