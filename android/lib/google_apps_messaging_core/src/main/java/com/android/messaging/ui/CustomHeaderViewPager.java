...
/**
 * A view that contains both a view pager and a tab strip wrapped in a linear
 * layout.
 */
public class CustomHeaderViewPager extends LinearLayout {
    ...
    public void setViewPagerTabHeight(final int tabHeight) {
        mTabstrip.getLayoutParams().height = tabHeight == DEFAULT_TAB_STRIP_SIZE ? mDefaultTabStripSize : tabHeight;
    }
