...
public class MarkAsReadAction extends Action implements Parcelable {
    ...
    protected Object executeAction() {
        ...
        // TODO: Consider doing this in background service to avoid delaying other
        // actions
    ...
    public static final Parcelable.Creator<MarkAsReadAction> CREATOR = new Parcelable.Creator<MarkAsReadAction>() {
        @Override
