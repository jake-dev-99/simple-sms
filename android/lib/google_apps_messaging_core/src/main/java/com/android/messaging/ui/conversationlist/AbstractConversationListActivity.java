...
/**
 * Base class for many Conversation List activities. This will handle the common
 * actions of multi
...
public abstract class AbstractConversationListActivity extends BugleActionBarActivity
    ...
    public void onActionBarArchive(final Iterable<SelectedConversation> conversations,
        ...
        final int textId = isToArchive ? R.string.archived_toast_message : R.string.unarchived_toast_message;
    ...
    public void onActionBarNotification(final Iterable<SelectedConversation> conversations,
        ...
        final int textId = isNotificationOn ? R.string.notification_on_toast_message
                : R.string.notification_off_toast_message;
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(final DialogInterface arg0, final int arg1) {
                        ...
                        final List<SnackBarInteraction> interactions = mConversationListFragment
                                .getSnackBarInteractions();
                        final UpdateDestinationBlockedAction.UpdateDestinationBlockedActionListener undoListener = new UpdateDestinationBlockedActionSnackBar(
                        ...
                        final UpdateDestinationBlockedAction.UpdateDestinationBlockedActionListener listener = new UpdateDestinationBlockedActionSnackBar(
