...
public class VCardContactItemData extends PersonItemData
    ...
    private final Binding<BindableMediaRequest<VCardResource>> mBinding = BindingBase.createBinding(this);
    private VCardResource mVCardResource;

    private static final Uri sDefaultAvatarUri = AvatarUriUtil.createAvatarUri(null, null, null, null);

    /**
     * Constructor. This parses data from the given MessagePartData describing the
     * vcard
     */
