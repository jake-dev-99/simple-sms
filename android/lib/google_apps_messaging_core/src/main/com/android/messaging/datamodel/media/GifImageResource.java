...
public class GifImageResource extends ImageResource {
    ...
    public Drawable getDrawable(Resources resources) {
        try {
            ...
            // Malicious gif images can make the platform throw different kind of
            // throwables, such
    ...
    public boolean supportsBitmapReuse() {
        // FrameSequenceDrawable a.) takes two bitmaps and thus does not fit into the
        // current
        // bitmap pool architecture b.) will rarely use bitmaps from one
        // FrameSequenceDrawable to
