...
import android.support.mms.ApnSettingsLoader;
...
public class BugleApnSettingsLoader implements ApnSettingsLoader {
    ...
    private static class DatabaseApn implements Apn {
         ...
         * @return an in-memory APN instance for database APN row, null if parameter
         *         invalid
         */
        ...
        private void moveToListHead() {
            // If this is being marked as a successful APN, move it to the top of the list
            // so
     ...
     * We try different combinations of the query to work around some platform
     * quirks.
     *
     ...
     * @return A cursor of the query result. If a cursor is returned as not null, it
     *         is
    ...
    /**
     * Make a query of local APN table based on MCC/MNC and APN name, sorted by
     * CURRENT
