...
/**
 * A class that contains the list of all participants potentially involved in a
 * conversation.
 * Includes both the participant records for each participant referenced in
 * conversation
 * participants table (i.e. "other" phone numbers) plus all participants
 * representing self
...
public class ConversationParticipantsData implements Iterable<ParticipantData> {
    ...
    ArrayList<ParticipantData> getParticipantListExcludingSelf() {
        final ArrayList<ParticipantData> retList = new ArrayList<ParticipantData>(mConversationParticipantsMap.size());
