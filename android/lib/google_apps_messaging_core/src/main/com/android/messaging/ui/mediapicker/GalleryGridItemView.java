...
/**
 * Shows an item in the gallery picker grid view. Hosts an FileImageView with a
 * checkbox.
 */
public class GalleryGridItemView extends FrameLayout {
    /**
     * Implemented by the owner of this GalleryGridItemView instance to communicate
     * on media
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        // The grid view auto-fit the columns, so we want to let the height match the
        // width
    ...
    private void updateImageView() {
        if (mData.isDocumentPickerItem()) {
            ...
            if (ContentType.isAudioType(contentType)) {
                ...
                final int templateId = isValidDate ? R.string.mediapicker_gallery_image_item_description
