...
public class FileUtil {
    ...
    /**
     * Creates an unused name to use for creating a new file. The format happens to
     * be similar
     ...
     * @return file name to be used for creating the new file. The caller is
     *         responsible for
    ...
    public static File getNewFile(File directory, String contentType) throws IOException {
        ...
        String fileNameFormat = context.getString(ContentType.isImageType(contentType)
                ? R.string.new_image_file_name_format
                : R.string.new_file_name_format);
    ...
    // Checks if the file is in /data, and don't allow any app to send personal
    // information.
    // We're told it's possible to create world readable hardlinks to other apps
    // private data
    ...
    /**
     * Checks, whether the child directory is the same as, or a sub-directory of the
     * base
     * directory.
     */
