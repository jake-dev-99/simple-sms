...
/**
 * Action to manually start an MMS download (after failed or manual mms
 * download)
 */
public class RedownloadMmsAction extends Action implements Parcelable {
    ...
    protected Object executeAction() {
        ...
        // Immediately update the notifications in case we came from the download action
        // from a
    ...
    public static final Parcelable.Creator<RedownloadMmsAction> CREATOR = new Parcelable.Creator<RedownloadMmsAction>() {
        @Override
