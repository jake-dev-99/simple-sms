...
/**
 * Provides an interface to expose Conversation List Cursor data to a UI widget
 * like a ListView.
 */
public class ConversationListAdapter
    ...
    /**
     * @see CursorRecyclerAdapter#bindViewHolder(
    ...
    public ConversationListViewHolder createViewHolder(final Context context,
        ...
        final ConversationListItemView itemView = (ConversationListItemView) layoutInflater.inflate(
