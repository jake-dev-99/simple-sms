...
public class PduPersister {
    ...
    public Uri persistPart(final PduPart part, final long msgId,
        ...
        try {
            ...
            // Currently the MMS provider throws an IllegalStateException when it's out of
            // space
     ...
     * @param preOpenedFiles if not null, a map of preopened InputStreams for the
     *                       parts.
    ...
    public Uri persist(final GenericPdu pdu, final Uri uri, final int subId,
        ...
        // Record whether this mms message is a simple plain text or not. This is a hint
        // for the
        // UI.
    ...
    private void checkAndLoadToCcRecipients(final HashSet<String> recipients,
        ...
        // If selfNumber is unavailable and there is only a single address in all TO and
        // CC, we can
