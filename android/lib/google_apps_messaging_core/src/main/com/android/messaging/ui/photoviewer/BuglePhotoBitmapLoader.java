...
public class BuglePhotoBitmapLoader extends AsyncTaskLoader<BitmapResult>
    ...
    // The drawable that is currently "in use" and being presented to the user. This
    // drawable
    ...
    public BitmapResult loadInBackground() {
        ...
        if (context != null && mPhotoUri != null) {
            final ImageRequestDescriptor descriptor = new UriImageRequestDescriptor(Uri.parse(mPhotoUri),
    ...
    /**
     * Called when there is new data to deliver to the client. The super class will
     * take care of
    ...
    public void onCanceled(BitmapResult result) {
        ...
        // At this point we can release the resources associated with 'drawable' if
        // needed.
        if (result != null) {
