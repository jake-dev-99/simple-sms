...
/**
 * Base class for operations that perform application business logic off the
 * main UI thread while
 * holding a wake lock.
 * .
 * Note all derived classes need to provide real implementation of Parcelable
 * (this is abstract)
 */
public abstract class Action implements Parcelable {
    ...
    // If derived classes keep their data in actionParameters then parcelable is
    // trivial
     ...
     * 
     * @return result to be passed in to
     *         {@link ActionExecutedListener#onActionExecuted}. It is
     *         also the result passed in to
     *         {@link ActionCompletedListener#onActionSucceeded} if
    ...
    /**
     * Queues up background actions for background processing after the current
     * action has
     * completed its processing ({@link #executeAction},
     * {processBackgroundCompletion}
     ...
     * be called. {@link #processBackgroundFailure} will be called on the Action
     * service thread
    ...
    /**
     * Process the success response from the background worker. Runs on action
     * service thread.
     * 
     * @param response the response returned by {@link #doBackgroundWork}
     * @return result to be passed in to
     *         {@link ActionCompletedListener#onActionSucceeded}
     */
    ...
    /**
     * Called in case of failures when sending background actions. Runs on action
     * service thread
     * 
     * @return result to be passed in to
     *         {@link ActionCompletedListener#onActionFailed}
     */
    ...
    /**
     * Queue an action and monitor for processing by the ActionService via the
     * factory helper
     */
    ...
    /**
     * Queue an action for delayed processing by the ActionService via the factory
     * helper
     */
    ...
    /**
     * Mark the end of local action execution - either completes the action or
     * queues
     * background actions
     */
    ...
    /**
     * Update action state to indicate that the background worker has posted its
     * response
    ...
    /**
     * Update action state to indicate the background action failed but is being
     * re-queued for retry
     */
    ...
    /**
     * Most derived classes use this base implementation (unless they include files
     * handles)
     */
    @Override
    ...
    /**
     * Derived classes need to implement writeToParcel (but typically should call
     * this method
    ...
    public Action(final Parcel in) {
        ...
        // Note: Need to set classloader to ensure we can un-parcel classes from this
        // package
