...
public class MediaPicker extends Fragment implements DraftMessageSubscriptionDataProvider {
    ...
    public interface MediaPickerListener {
        ...
        /**
         * Called when the media picker goes into or leaves full screen mode so the host
         * can
        ...
        /**
         * Called when the media picker is closed. Always called immediately after
         * onItemsSelected
         */
        void onDismissed();
    ...
    public View onCreateView(
        ...
        for (final MediaChooser chooser : mChoosers) {
            ...
            final boolean enabled = (chooser.getSupportedMediaTypes() & mSupportedMediaTypes) != MEDIA_TYPE_NONE;
        ...
        mViewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                // translate the index back. For example, if the user clicked the item most to
                // the
        ...
        // Camera initialization is expensive, so don't realize offscreen pages if not
        // needed.
    ...
    /**
     * Opens the media picker and optionally shows the chooser for the supplied
     * media type
     *
     * @param startingMediaType The media type of the chooser to open if
     *                          {@link #MEDIA_TYPE_DEFAULT}
     *                          is used, then the default chooser from saved shared
     *                          prefs is opened
     */
    public void open(final int startingMediaType, final boolean animate) {
        ...
        if (mIsAttached) {
            ...
            // open() can get called immediately after the MediaPicker is created. In that
            // case,
    ...
    private void doOpen(int startingMediaType, final boolean animate) {
        ...
        // If no specific starting type is specified (i.e. MEDIA_TYPE_DEFAULT), try to
        // get the
     ...
     *
     * @param mediaTypes The bit flags of media types to allow. Can be any
     *                   combination of the
     *                   MEDIA_TYPE_* values
     */
