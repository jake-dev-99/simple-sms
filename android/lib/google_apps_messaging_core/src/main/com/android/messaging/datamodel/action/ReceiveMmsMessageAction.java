...
public class ReceiveMmsMessageAction extends Action implements Parcelable {
    ...
    protected Object executeAction() {
        ...
        if (mms != null) {
            ...
            final String conversationId = BugleDatabaseOperations.getOrCreateConversationFromThreadId(db, mms.mThreadId,
                    blocked, subId);
            ...
            try {
                ...
                // else update the conversation once we have downloaded final message (or
                // failed)
    ...
    public static final Parcelable.Creator<ReceiveMmsMessageAction> CREATOR = new Parcelable.Creator<>() {
        @Override
