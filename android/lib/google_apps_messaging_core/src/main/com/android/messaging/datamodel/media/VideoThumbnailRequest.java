 ...
 * Users of this class as responsible for checking
 * {@link #shouldShowIncomingVideoThumbnails}
 */
public class VideoThumbnailRequest extends ImageRequest<UriImageRequestDescriptor> {
    ...
    protected Bitmap getBitmapForResource() throws IOException {
        Bitmap bitmap = null;
        // Get a thumbnail through MediaMetadataRetriever to get a representative frame
        // at any time
        // position instead.
