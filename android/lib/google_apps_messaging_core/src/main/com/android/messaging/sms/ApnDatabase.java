...
public class ApnDatabase extends SQLiteOpenHelper {
    ...
    // APN table
    private static final String APN_TABLE_SQL = "CREATE TABLE " + APN_TABLE +
     ...
     * To ensure that it works in a testing environment it needs to never access the
     * factory context
     */
    ...
    public static void forceBuildAndLoadApnTables() {
        ...
        // APNs). Some JB MR2 devices also throw the security exception, so we're
        // building
