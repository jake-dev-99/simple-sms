 ...
 * traditional actionBar tabs,
 * but allows for the view containing the tabs to be placed anywhere on screen.
 * Text-related
 * attributes can also be assigned in XML - these will get propogated to the
 * child TextViews
 * automatically.
 *
 * Note: this file is taken from the AOSP
 * /packages/apps/ContactsCommon/src/com/android/contacts/
 * common/list/ViewPagerTabs.java. Some platform specific API calls (e.g.
 * ViewOutlineProvider which
