...
public class UpdateConversationArchiveStatusAction extends Action {
    ...
    public static void archiveConversation(final String conversationId) {
        final UpdateConversationArchiveStatusAction action = new UpdateConversationArchiveStatusAction(conversationId,
                true /* isArchive */);
        action.start();
    }
    ...
    public static final Parcelable.Creator<UpdateConversationArchiveStatusAction> CREATOR = new Parcelable.Creator<UpdateConversationArchiveStatusAction>() {
        @Override
