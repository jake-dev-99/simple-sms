...
public class MessagingContentProvider extends ContentProvider {
     ...
     * <p>
     * <b>IMPORTANT!</b> You probably shouldn't be calling this. Prefer to notify
     * more specific
     * uri's instead. Currently only sync uses this, because sync can potentially
     * update many
    ...
    public Cursor query(final Uri uri, final String[] projection, String selection,
        ...
        // scratch space; we grant uri read access on a case-by-case basis. Dialer app
        // and
        // contacts app would doQuery() on the vCard uri before trying to open the
        // inputStream.
    ...
    public String getType(final Uri uri) {
        final StringBuilder sb = new StringBuilder("vnd.android.cursor.dir/vnd.android.messaging.");
    ...
    public boolean onCreate() {
        ...
        // We cannot initialize mDatabaseWrapper yet as the Factory may not be
        // initialized
        return true;
    }
}
