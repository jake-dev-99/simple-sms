...
abstract class BaseWidgetFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    /**
     * Returns the number of items that should be shown in the widget list. This
     * method also
     * updates the boolean that indicates whether the "show more" item should be
     * shown.
     * 
    ...
    /**
     * Returns the number of messages that should be shown in the widget. This
     * method
     * doesn't update the boolean that indicates whether the "show more" item should
     * be included
     * in the list.
     * 
     * @return
    ...
    protected Bitmap getAvatarBitmap(final Uri avatarUri) {
        final String avatarType = avatarUri == null ? null : AvatarUriUtil.getAvatarType(avatarUri);
