...
public class ReceiveSmsMessageAction extends Action implements Parcelable {
    ...
    protected Object executeAction() {
        ...
        final String conversationId = BugleDatabaseOperations.getOrCreateConversationFromRecipient(db, threadId,
                blocked, rawSender);
        ...
        // Only the primary user gets to insert the message into the telephony db and
        // into bugle's
        // db. The secondary user goes through this path, but skips doing the actual
        // insert. It
        // goes through this path because it needs to compute
        // messageInFocusedConversation in order
        // to calculate whether to skip the notification and play a soft sound if the
        // user is
    ...
    public static final Parcelable.Creator<ReceiveSmsMessageAction> CREATOR = new Parcelable.Creator<ReceiveSmsMessageAction>() {
        @Override
