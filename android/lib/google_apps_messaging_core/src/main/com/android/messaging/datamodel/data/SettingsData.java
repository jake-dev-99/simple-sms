...
/**
 * Services SettingsFragment's data needs for loading active self participants
 * to display
...
public class SettingsData extends BindableData implements
    ...
    public List<SettingsItem> getSettingsItems() {
        ...
        // For per-subscription settings, show the actual SIM name with phone number if
        // the
