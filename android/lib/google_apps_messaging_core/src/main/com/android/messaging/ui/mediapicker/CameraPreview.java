...
/**
 * Contains shared code for SoftwareCameraPreview and HardwareCameraPreview,
 * cannot use inheritance
 * because those classes must inherit from separate Views, so those classes
 * delegate calls to this
...
public class CameraPreview {
    ...
    /**
     * @return True if the view is valid and prepared for the camera to start
     *         showing the preview
     */
    ...
    /**
     * Starts the camera preview on the current surface. Abstracts out the
     * differences in API
