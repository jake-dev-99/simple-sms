...
public class AttachmentPreviewFactory {
    ...
    public static MultiAttachmentLayout createMultiplePreview(final Context context,
        ...
        final MultiAttachmentLayout multiAttachmentLayout = new MultiAttachmentLayout(context, null);
    ...
    private static View createPendingAttachmentPreview(final LayoutInflater layoutInflater,
        ...
        final View pendingItemView = layoutInflater.inflate(R.layout.attachment_pending_item,
                parent, false);
        final ImageView imageView = (ImageView) pendingItemView.findViewById(R.id.pending_item_view);
        ...
        layoutParams.width = attachmentData.getWidth() == MessagePartData.UNSPECIFIED_SIZE ? defaultSize
                : attachmentData.getWidth();
        layoutParams.height = attachmentData.getHeight() == MessagePartData.UNSPECIFIED_SIZE ? defaultSize
                : attachmentData.getHeight();
    ...
    private static View createAudioPreview(final LayoutInflater layoutInflater,
        ...
        final View view = layoutInflater.inflate(layoutId, parent, false /* attachToRoot */);
        final AudioAttachmentView audioView = (AudioAttachmentView) view.findViewById(R.id.audio_attachment_view);
