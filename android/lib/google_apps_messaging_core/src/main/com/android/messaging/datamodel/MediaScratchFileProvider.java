...
/**
 * A very simple content provider that can serve media files from our cache
 * directory.
 */
public class MediaScratchFileProvider extends FileProvider {
    private static final String TAG = LogUtil.BUGLE_TAG;

    private static final SimpleArrayMap<Uri, String> sUriToDisplayNameMap = new SimpleArrayMap<Uri, String>();
    ...
    public Cursor query(final Uri uri, final String[] projection, final String selection,
        ...
        if (projection != null && projection.length > 0 &&
            ...
            // Retrieve the display name associated with a temp file. This is used by the
            // Contacts
