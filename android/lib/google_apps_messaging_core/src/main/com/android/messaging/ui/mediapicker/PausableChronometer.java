...
/**
 * A pausable Chronometer implementation. The default Chronometer in Android
 * only stops the UI
 * from updating when you call stop(), but doesn't actually pause it. This
 * implementation adds an
 * additional timestamp that tracks the timespan for the pause and compensate
 * for that.
 */
public class PausableChronometer extends Chronometer implements PlaybackStateView {
    // Keeps track of how far long the Chronometer has been tracking when it's
    // paused. We'd like
