...
public class MmsSender {
     ...
     * @param messageUri The unique URI of the message for identifying it during
     *                   sending
     ...
     *
     * @param context           Context
     * @param messageUri        The unique URI of the message for identifying it
     *                          during sending
     * @param locationUrl       The optional URL to send to
     * @param pdu               The PDU to send
     * @param responseImportant If the sending response is important. Responses to
     *                          the
     *                          Sending of AcknowledgeInd and NotifyRespInd are not
     *                          important.
     * @throws MmsFailureException
     */
