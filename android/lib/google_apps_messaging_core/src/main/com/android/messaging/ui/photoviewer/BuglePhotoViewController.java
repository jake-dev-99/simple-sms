...
/**
 * Customizations for the photoviewer to display conversation images in full
 * screen.
 */
public class BuglePhotoViewController extends PhotoViewController {
    ...
    /**
     * Checks whether the current photo is a temp file. A temp file can be deleted
     * at any time, so
     * we need to disable share and save options because the file may no longer be
     * there.
     */
