...
public class BugleApplication extends Application implements UncaughtExceptionHandler {
    ...
    // Called by the "real" factory from FactoryImpl.register() (i.e. not run in
    // tests)
    public void initializeSync(final Factory factory) {
        ...
        final CarrierConfigValuesLoader carrierConfigValuesLoader = factory.getCarrierConfigValuesLoader();
    ...
    private void maybeHandleSharedPrefsUpgrade(final Factory factory) {
        ...
        if (targetVersion > existingVersion) {
            ...
            // We don't care about downgrade since real user shouldn't encounter this, so
            // log it
