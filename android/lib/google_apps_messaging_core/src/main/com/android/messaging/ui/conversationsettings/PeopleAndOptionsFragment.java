...
public class PeopleAndOptionsFragment extends Fragment
    ...
    public void onParticipantsListLoaded(final PeopleAndOptionsData data,
        ...
        final ParticipantData otherParticipant = participants.size() == 1 ? participants.get(0) : null;
     ...
     * PeopleAndOptionsItemViews to individual COLUMNS of the first cursor record.
     * (Note
     * that this is not a CursorAdapter because it treats individual columns of the
     * cursor as
     * separate options to display for the conversation, e.g. notification
     * settings).
     */
    private class OptionsListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, final View convertView, final ViewGroup parent) {
            ...
            if (convertView != null && convertView instanceof PeopleOptionsItemView) {
                ...
                itemView = (PeopleOptionsItemView) inflater.inflate(R.layout.people_options_item_view, parent, false);
            }
    ...
    /**
     * Represents a partition/section in the People & Options list (e.g. "general
     * options" and
