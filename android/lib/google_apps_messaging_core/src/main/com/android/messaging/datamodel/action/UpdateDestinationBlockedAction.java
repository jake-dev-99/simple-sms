...
public class UpdateDestinationBlockedAction extends Action {
    ...
    public static UpdateDestinationBlockedActionMonitor updateDestinationBlocked(
        ...
        final UpdateDestinationBlockedActionMonitor monitor = new UpdateDestinationBlockedActionMonitor(null, listener);
        final UpdateDestinationBlockedAction action = new UpdateDestinationBlockedAction(destination, blocked,
                conversationId,
    ...
    public static final Parcelable.Creator<UpdateDestinationBlockedAction> CREATOR = new Parcelable.Creator<UpdateDestinationBlockedAction>() {
        @Override
