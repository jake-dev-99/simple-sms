 ...
 * allows the
 * consumer to optionally decode image resources using unused bitmaps stored in
 * the cache.
 */
public class PoolableImageCache extends MediaCache<ImageResource> {
    ...
    /**
     * A bitmap pool representation built on top of the image cache. It treats the
     * image resources
     * stored in the image cache as a self-contained bitmap pool and is able to
     * create or
    ...
    public class ReusableImageResourcePool {
        ...
        /**
         * A sparse array from bitmap size to a list of image cache entries that match
         * the
         * given size. This map is used to quickly retrieve a usable bitmap to be reused
         * by an
         * incoming ImageRequest. We need to ensure that this sparse array always
         * contains only
        ...
        /**
         * Called when a new image resource is added to the cache. We add the resource
         * to the
        ...
        /**
         * Called when an image resource is evicted from the cache. Bitmap pool's
         * entries are
         * strictly tied to their presence in the image cache. Once an image is evicted
         * from the
        ...
        /**
         * Try to get a reusable bitmap from the pool with the given width and height.
         * As a
        ...
        /**
         * Try to locate and return a reusable bitmap from the pool, or create a new
         * bitmap.
         * 
         * @param width  desired bitmap width
         * @param height desired bitmap height
         * @return the created or reused mutable bitmap that has its background cleared
         *         to
         ...
         * @return the created or reused mutable bitmap with the requested background
         *         color
         */
        public Bitmap createOrReuseBitmap(final int width, final int height,
