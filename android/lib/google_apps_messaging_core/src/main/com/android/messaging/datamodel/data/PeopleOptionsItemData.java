...
public class PeopleOptionsItemData {
     ...
     * that it binds to columns because it treats individual columns of the cursor
     * as
    ...
    public void bind(
        ...
        switch (settingType) {
            ...
            case SETTING_BLOCKED:
                ...
                final int resourceId = otherParticipant.isBlocked() ? R.string.unblock_contact_title
