...
public class WidgetPickConversationActivity extends BaseBugleActivity implements
    ...
    public void onCreateConversationClick() {
        // We should never get here because we're hiding the new conversation button in
        // the
        // ShareIntentFragment by setting HIDE_NEW_CONVERSATION_BUTTON_KEY in the
        // arguments.
        finish();
    }
    ...
    // Delete the ConversationId preference from the SharedPreferences object for
    // this widget.
