...
public class MmsSmsUtils {
    ...
    /**
     * This pattern is intended for searching for carrier specific phone numbers
     * starting with star
     * sign and digits such as the voice mail number.
     * (e.g. *20 Chile Claro)
     */
    private static final Pattern PHONE_NUMBER_STARTING_WITH_STAR_PATTERN = Pattern.compile("\\*[0-9]+");
