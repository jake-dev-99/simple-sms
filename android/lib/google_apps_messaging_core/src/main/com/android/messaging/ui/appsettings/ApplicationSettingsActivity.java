...
public class ApplicationSettingsActivity extends BugleActionBarActivity {
    ...
    public static class ApplicationSettingsFragment extends PreferenceFragment implements
        ...
        public void onCreate(final Bundle savedInstanceState) {
            ...
            mNotificationsEnabledPreferenceKey = getString(R.string.notifications_enabled_pref_key);
            ...
            if (topLevel) {
                ...
                // Hide the Advanced settings screen if this is not top-level; these are shown
                // at
        ...
        private void updateSoundSummary(final SharedPreferences sharedPreferences) {
            ...
            // Bootstrap the default setting in the preferences so that we have a valid
            // selection
