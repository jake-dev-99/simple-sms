...
public class DataModelImpl extends DataModel {
    ...
    private static final ConcurrentHashMap<Integer, ConnectivityUtil> sConnectivityUtilInstanceCacheN = new ConcurrentHashMap<>();
    ...
    public ActionService getActionService() {
        // We need to allow access to this on the UI thread since it's used to start
        // actions.
    ...
    public DatabaseWrapper getDatabase() {
        // We prevent the main UI thread from accessing the database since we have to
        // allow
    ...
    public void onActivityResume() {
        ...
        // Trigger a participant refresh if needed, we should only need to refresh if
        // there is
    ...
    public void onApplicationCreated() {
        ...
        if (OsUtil.isAtLeastL_MR1()) {
            // Start listening for subscription change events for refreshing any data
            // associated
            // with subscriptions.
