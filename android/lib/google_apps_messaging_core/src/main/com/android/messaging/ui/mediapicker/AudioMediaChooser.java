...
class AudioMediaChooser extends MediaChooser implements
    ...
    public boolean isHandlingTouch() {
        // Whenever the user is in the process of recording audio, we want to allow the
        // user
        // to move the finger within the panel without interpreting that as dragging the
        // media
        // picker panel.
