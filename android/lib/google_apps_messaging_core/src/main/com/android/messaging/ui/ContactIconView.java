...
public class ContactIconView extends AsyncImageView {
    ...
    /**
     * Method which allows the automatic hookup of a click handler when the Uri is
     * changed
     */
    ...
    /**
     * A convenience method that sets the URI of the contact icon by creating a new
     * image request.
     */
    ...
    protected void maybeInitializeOnClickListener() {
        if ((mContactId > ParticipantData.PARTICIPANT_CONTACT_ID_NOT_RESOLVED
            ...
            // This should happen when the phone number is not in the user's contacts or it
            // is a
            // group conversation, group conversations don't have contact phone numbers. If
            // this
