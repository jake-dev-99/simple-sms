...
/**
 * Launches ConversationActivity for sending a message to, or viewing messages
 * from, a specific
 * recipient.
 * <p>
...
public class LaunchConversationActivity extends Activity implements
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_SENDTO.equals(action) || Intent.ACTION_VIEW.equals(action)) {
            ...
            final String commaSeparatedRecipients = UriUtil.parseRecipientsFromSmsMmsUri(intent.getData());
        ...
        // As of M, activities without a visible window must finish before onResume
        // completes.
        finish();
    }
