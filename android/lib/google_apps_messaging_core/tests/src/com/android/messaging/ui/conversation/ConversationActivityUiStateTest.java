...
public class ConversationActivityUiStateTest extends BugleTestCase {
    @Mock
    protected ConversationActivityUiStateHost mockListener;

    /**
     * Test the Ui state where we start off with the contact picker to pick the
     * first contact.
     */
    public void testPickInitialContact() {
        ...
        Mockito.verify(mockListener, Mockito.times(1)).onParticipantPickerUiStateChanged(
    ...
    /**
     * Test the Ui state where we have both the chips view and the conversation view
     * and we
    ...
    public void testCommitAddParticipant() {
        ...
        // After adding more contacts, the terminal state is always conversation only
        // (i.e. we
