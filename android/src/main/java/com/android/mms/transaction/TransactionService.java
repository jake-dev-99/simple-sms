...
//                            MessagingNotification.updateDownloadFailedNotification(this);
    ...
    private synchronized void createWakeLock() {
        ...
        if (mWakeLock == null) {
            ...
            mWakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "SimpleSms:MMS Connectivity");
    ...
    protected int beginMmsConnectivity() throws IOException {
        ...
        int result = -1;
        {
            ...
            // Request network - the connection is maintained until released
            mConnMgr.requestNetwork(networkRequest, new ConnectivityManager.NetworkCallback());
            result = 0; // Consider it successful
        }
