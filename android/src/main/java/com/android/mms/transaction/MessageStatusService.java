...
/**
 * Service that gets started by the MessageStatusReceiver when a message status
 * report is
 * received.
 */
public class MessageStatusService extends IntentService {
    ...
    public MessageStatusService() {
        ...
        // Intent should be redelivered if the process gets killed before completing the
        // job.
