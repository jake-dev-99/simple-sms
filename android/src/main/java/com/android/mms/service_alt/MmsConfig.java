...
public class MmsConfig {
    ...
    static {
        DEFAULTS.put(CONFIG_ENABLED_MMS, Boolean.TRUE);
        DEFAULTS.put(CONFIG_ENABLED_TRANS_ID, Boolean.FALSE);
        DEFAULTS.put(CONFIG_ENABLED_NOTIFY_WAP_MMSC, Boolean.FALSE);
        DEFAULTS.put(CONFIG_ALIAS_ENABLED, Boolean.FALSE);
        DEFAULTS.put(CONFIG_ALLOW_ATTACH_AUDIO, Boolean.TRUE);
        DEFAULTS.put(CONFIG_ENABLE_MULTIPART_SMS, Boolean.TRUE);
        DEFAULTS.put(CONFIG_ENABLE_SMS_DELIVERY_REPORTS, Boolean.TRUE);
        DEFAULTS.put(CONFIG_ENABLE_GROUP_MMS, Boolean.TRUE);
        DEFAULTS.put(CONFIG_SUPPORT_MMS_CONTENT_DISPOSITION, Boolean.TRUE);
        DEFAULTS.put(CONFIG_CELL_BROADCAST_APP_LINKS, Boolean.TRUE);
        DEFAULTS.put(CONFIG_SEND_MULTIPART_SMS_AS_SEPARATE_MESSAGES, Boolean.FALSE);
        DEFAULTS.put(CONFIG_ENABLE_MMS_READ_REPORTS, Boolean.FALSE);
        DEFAULTS.put(CONFIG_ENABLE_MMS_DELIVERY_REPORTS, Boolean.FALSE);
        DEFAULTS.put(CONFIG_SUPPORT_HTTP_CHARSET_HEADER, Boolean.FALSE);
        DEFAULTS.put(CONFIG_MAX_MESSAGE_SIZE, 300 * 1024);
        DEFAULTS.put(CONFIG_MAX_IMAGE_HEIGHT, MAX_IMAGE_HEIGHT);
        DEFAULTS.put(CONFIG_MAX_IMAGE_WIDTH, MAX_IMAGE_WIDTH);
        DEFAULTS.put(CONFIG_RECIPIENT_LIMIT, Integer.MAX_VALUE);
        DEFAULTS.put(CONFIG_HTTP_SOCKET_TIMEOUT, 60 * 1000);
